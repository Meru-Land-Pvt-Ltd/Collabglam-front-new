                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <div className="relative w-full min-w-[280px] sm:w-[320px] lg:w-[360px]">
                            ...
                            <Input
                                ...
                                className="h-12 rounded-m border-border/70 bg-background pl-11 pr-4 text-right placeholder:text-right shadow-none"
                            />
                        </div>
                ...
                <div className="flex-1 overflow-hidden">
                    <div className="h-full overflow-y-auto px-3 pb-4">
                        {mails.map((mail) => (
                            <div
                                key={mail.id}
                                onClick={() => router.push(`/brand/inbox/${mail.id}`)}
                                className={cn(
                                ...
                                <div className="ml-auto flex items-center justify-end gap-4">
                                    ...
                                    >
                                        <Star
                                            ...
                                            className={cn(
                                                "h-4 w-4",
                                                mail.starred ? "text-[#FFBF00]" : "text-muted-foreground"
                                            )}
                                        />
                                    </button>
